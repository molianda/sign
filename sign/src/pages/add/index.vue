    ...
    <div class="wrap">
        ...
        <ul>
            <li>
                ...
                <input type="text" v-model="current.company" placeholder="请输入公司的名称">
            </li>
            <li>
                <label for="">公司电话</label>
                <input type="number" v-model="current.phone" placeholder="请输入面试人联系电话">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" @tap="goSearch" disabled placeholder="请选择面试地址" v-model="current.address.address"/>
            </li>
        </ul>
        <p>备注信息</p>
        <textarea type="text"  v-model="current.description" placeholder="备注信息（可选，100个字以内）"></textarea>
        <button :class="btnEnable?'':'disable'" @click="submit" pri>确认</button>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        columnChange(e){
            let {column,value}=e.target;//代表小时
